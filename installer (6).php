...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20251024_sportvision_b3ff0fc600613d489312_20251107095759_archive.zip';
        const ARCHIVE_SIZE       = '51444211';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'b3ff0fc-07095759';
        const SECONDARY_PACKAGE_HASH = '952b188-07095759';
