...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20251024_sportvision_3b71a1e90845ecd96803_20251025065453_archive.zip';
        const ARCHIVE_SIZE       = '47173109';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '3b71a1e-25065453';
        const SECONDARY_PACKAGE_HASH = '9df203e-25065453';
